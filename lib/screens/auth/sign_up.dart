...
class _SignUpState extends State<SignUp> {
  ...
  void initState() {
    ...
    usernameController.text = "Enter Your Name";
    onUserNameChange();
    super.initState();
  }
          ...
          child: Form(
            ...
            child: ListView(
              children: [
                ...
                Text("Chatting Application", style: TextDesign().popHead.copyWith(color: MyColor.primary, fontSize: 22)),
                const SizedBox(height: 10),
                Container(
                    height: size.height * 0.25,
                    width: double.infinity,
                    decoration: BoxDecoration(color: MyColor.primary, borderRadius: BorderRadius.circular(10)), padding: const EdgeInsets.all(20),
